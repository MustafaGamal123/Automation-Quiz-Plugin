...
$string['course_proctoring_summary'] = 'Course Proctoring Summary';
...
$string['settingscontroll:deleteall'] = 'Delete all images of students that were captured during the exams.';
...
$string['settingscontroll:deletealllinktext'] = 'Delete all images';
...
$string['viewwarnings'] = 'View warnings';
...
$string['imagesdeleted'] = 'All images and records have been successfully deleted.';
$string['cheating_status'] = 'Cheating Status';
$string['pluginname'] = 'Quiz proctoring';
$string['messageprovider:suspicious_activity'] = 'Quiz proctoring alerts';
$string['proctoring'] = 'Proctoring';
$string['proctoring_help'] = 'Enable face detection and behavior monitoring during quiz attempts.';

// Warning types
$string['warning_face'] = 'Face not detected';
$string['warning_movement'] = 'Excessive movement detected';
$string['warning_face_turned'] = 'Face turned away from camera';
$string['warning_multiple_faces'] = 'Multiple faces detected';
$string['warning_unknown'] = 'Suspicious activity detected';

// Notification messages
$string['notification_subject'] = 'Quiz Proctoring Alert: {$a}';
$string['notification_body'] = 'The student named {$a->studentname}, with the email {$a->email}, received the warning "{$a->warning}" in the quiz titled "{$a->quizname}".';
$string['notification_small'] = '{$a->studentname}: {$a->warning} in {$a->quizname}';

$string['pluginname'] = 'Quiz Proctoring';
$string['proctoring'] = 'Proctoring';
$string['messageprovider:proctoring_warning'] = 'Proctoring warning alerts';
$string['proctoring_warning_subject'] = 'Proctoring Alert: {$a->warning}';
$string['proctoring_warning_body'] = 'The student named {$a->student}, with the email {$a->email}, received the warning "{$a->warning}" in the quiz titled "{$a->quiz}".';
$string['notification_sent'] = 'Notification sent to {$a} instructors';
$string['warnings'] = 'Warnings Summary';
$string['student_warnings_reporttt'] = 'Student Warnings Report';
$string['student_warnings_report_for_quiz'] = 'Student Warnings Report for Quiz';
$string['student_warning_report_template'] = 'The student named {$a->name}, with the email {$a->email}, received the warning "{$a->warning}" {$a->count} times in the quiz titled "{$a->quizname}".';
$string['no_warnings_found'] = 'No warnings found for any students in this quiz.';
$string['back_to_summary'] = 'Back to Summary';
$string['report'] = 'Report';
$string['warning_unknown'] = 'Unknown warning';
$string['warning_multiple_faces'] = 'Multiple faces detected';
$string['warning_no_face'] = 'No face detected';
